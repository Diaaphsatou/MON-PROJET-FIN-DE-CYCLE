...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Ajouter une livraison</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
...
<section class="content">
  <div class="container-fluid">
    <form method="post" action="{{ route('livraison.store') }}" enctype="multipart/form-data">
      ...
      <div class="col-md-12">
       ...
       <div class="form-group">
        <div class="row">
          <label class="col-md-3">Date de livraison</label>
      ...
      <div class="form-group">
        <div class="row">
          ...
          <div class="col-md-6"><input type="text" name="destination" class="form-control"></div>
          <div class="clearfix"></div>
        </div>
      </div>
      ...
      <div class="form-group">
        <div class="row">
          <label class="col-md-3">Tranport</label>
          <div class="col-md-6"><input type="text" name="transport" class="form-control"></div>
          <div class="clearfix"></div>
        </div>
      </div>
